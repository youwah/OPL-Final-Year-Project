...
/*	    session_start();
	   ...
	   <tr>
                ...
                <td><a href="reviewlogbook.php?logid=<?php echo $row["logid"]; ?>&studentname=<?php echo $_GET["studentname"]; ?>&studentemail=<?php echo $row["email"]; ?>"><button type="button" >Review</button></a></td>
