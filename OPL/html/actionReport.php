...
<div>
<h2 style="text-align:center; font-size: 50px; margin-top: 0.15em; margin-bottom: -1em;">Logbook List</h2>
</div><br><br><br>
...
<div class="select" >
    <?php
        ...
        $month =$_POST['month'];
         ...
         $sqlloaduser = "SELECT * FROM tbl_272043_logbook WHERE email ='$email'";
         
     if(isset($_POST['sortyear'])){

            $sqlloaduser = "SELECT * FROM tbl_272043_logbook WHERE month ='$month' AND email ='$email'";
        }
...
<div class="container2">
	...
	/*    session_start();
	   ...
	   <tr>
                ...
                <td><a href="editlogbook.php?logid=<?php echo $row["logid"]; ?>"><button type="button" >View</button></a></td>
