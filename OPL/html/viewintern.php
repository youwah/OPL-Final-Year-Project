...
<h2 style="text-align:center; font-size: 50px; margin-top: 0.15em; margin-bottom: -1em;"><?php echo $_GET["namesup"]; ?>'s Intern Name List</h2>
...
<div class="container2">
	...
	<table id="example"  style="width:100%">
	    ...
	    $sqlloaduser = "SELECT * FROM tbl_272043_internlist WHERE supemail ='$supemail' ";
	   ...
	   <tr>
                ...
                <td><a href="deletei.php?semail=<?php echo $row["semail"]; ?>&supemail=<?php echo $_GET["email"];?>&namesup=<?php echo $_GET["namesup"]; ?>"><button type="button" onclick="return confirm('Are you sure you want to delete?')" >Delete</button></a></td>
