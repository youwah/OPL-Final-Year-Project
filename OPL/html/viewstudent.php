...
<h2 style="text-align:center; font-size: 50px; margin-top: 0.15em; margin-bottom: -1em;"><?php echo $_GET["namelec"]; ?>'s Student Name List</h2>
<div class="select" >
    <?php
        session_start();
        error_reporting(0);
        ...
        $lemail=$_GET["email"];
         ...
         $sqlloaduser = "SELECT * FROM tbl_272043_studentlist ";
...
<div class="container2">
	...
	<table id="example"  style="width:100%">
	    ...
	    $sqlloaduser = "SELECT * FROM tbl_272043_studentlist WHERE lemail ='$lecemail' ";
	   ...
	   <tr>
                ...
                <td><a href="deletes.php?semail=<?php echo $row["semail"]; ?>&lemail=<?php echo $_GET["email"]; ?>&lecname=<?php echo $_GET["namelec"]; ?>"><button type="button" onclick="return confirm('Are you sure you want to delete?')" >Delete</button></a></td>
