...
<h2 style="text-align:center; font-size: 50px; margin-top: 0.15em; margin-bottom: -1em;">Student Name List</h2>
...
<div class="container2">
	...
	<table id="example"  style="width:100%">
	    ...
	    $sqlloaduser = "SELECT * FROM tbl_272043_studentlist WHERE lemail ='$email' ";
	   ...
	   <tr>
                ...
                <td><a href="studentporfile.php?studentemail=<?php echo $row["semail"]; ?>"><?php echo $row["semail"] ?></a></td>
                <td><?php echo $row["name"] ?></td>
                <td><?php echo $row["ic_number"] ?></td>
                <td><a href="viewpage.php?studentemail=<?php echo $row["semail"]; ?>&studentname=<?php echo $row["name"]; ?>"><button type="button" >View</button></a></td>
