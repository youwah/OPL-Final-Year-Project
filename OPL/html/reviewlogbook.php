...
<div class="header"style="position:relative">
 ...
 <div class="topnav mb-3 mt-4">
        ...
        <div style="margin-bottom: 40px;">
                   ...
                   <form class="myForm1" action="verifylog.php?logid=<?php echo $_GET["logid"]?>&studentname=<?php echo $_GET["studentname"]?>&studentemail=<?php echo $_GET["studentemail"]?>" method="POST" enctype="multipart/form-data">
            <!--Text Field Container-->
			<div class="containersignup4">
                <!--Hearder-->
                <h2 align="center">REVIEW LOGBOOK</h2>
                <!--First Name-->
    ...
    $result = $conn->query($sqlloaduser);
		...
		<?php
                ...
                <!--Comment-->
                    ...
                    <textarea rows="10" cols="72" name="comment" placeholder="Please make a comment"  ><?php echo $comment; ?></textarea>
                </div>
                <!--Button-->
                <div class="rowsignupB" align="center">

                    <input type="submit" class="submitsignup" onclick="return confirm('Are you sure want to comment?')" name="commenttt" value="Verify">
