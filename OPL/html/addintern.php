...
<div class="select" >
    <?php
        ...
        $status =$_POST['status'];
         ...
         $sqlloaduser = "SELECT * FROM tbl_272043_student ";
...
<div class="container2">
	...
	<table id="example"  style="width:100%">
	   ...
	   <tr>
                ...
                <td><a href="addi.php?semail=<?php echo $row["email"];?>&supemail=<?php echo $_GET["email"]; ?>&supname=<?php echo $_GET["supname"] ?>&name= <?php echo $row["lname"] ?>&ic_number=<?php echo $row["ic_number"] ?>"><button type="button" onclick="return confirm('Are you sure you want to add?')" >Add</button></a></td>
