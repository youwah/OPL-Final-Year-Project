...
if (isset($_POST['submitok'])){
        ...
        echo "<script type='text/javascript'>window.location.assign('viewstudentlog.php');</script>'";
...
<div class="header"style="position:relative">
 ...
 <div class="topnav mb-3 mt-4">
	...
	<div style="height: 350px; width:80%;background-color: white;max-width:1920px; min-width:480px; margin-center:auto; margin-right:auto; margin:auto; padding:auto; overflow:hidden;float:center">
		<div style="margin-left: 10px;margin-top: 10px; background-color: white; height: 50px; width:250px;float:left"><i class="material-icons" style="float: left;margin-top: 5px;margin-left: 5px; font-size: 40px">&#xe7fd;</i><span class="discover" style="margin-left: 10px;margin-top: 13px">Student Detail</span></div>
		<br><br>
		<?php
	    session_start();
        error_reporting(0);
