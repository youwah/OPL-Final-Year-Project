...
<p class="mb-100 mt-10"><br>
    ...
    <p align=center>
	    ...
	    ?>
		<div style="text-align: center; margin-top: 5px"><span class="discover" style="color:black; float: none; margin-left: 0px"><?php echo $lname ?></span></div>
		<div style="height:-20px; width:100px; background-color:white; margin-left:auto;margin-right:auto; position:relative">
	
		</div>
		<h3 style="text-align:center;" class="display-4">Role:Supervisor</h3>
		
			</div>
     <div class="row"  >
  <div class="column" >
      
     <button type="submit" class="btn" onclick="document.location='locationinternlist.php'"><b>Check Location</b></button>
  </div>  
  
  
  <div class="column">
      <button type="submit" class="btn2" onclick="document.location='reviewintern.php'"><b>Review Logbook</b></button>
  </div>  
  
  <div class="column" >
      <button type="submit" class="btn3" onclick="document.location='supprofile.php'"><b>My Porfile</b></button>
  </div>  
