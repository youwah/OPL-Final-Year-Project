...
<div class="container2">
	...
	<table id="example"  style="width:100%">
	   ...
	   <tr>
                ...
                <td><a href="adds.php?semail=<?php echo $row["email"];?>&lemail=<?php echo $_GET["email"]; ?>&lecname=<?php echo $_GET["lecname"] ?>&name=<?php echo $row["lname"] ?>&ic_number=<?php echo $row["ic_number"] ?>"><button type="button" onclick="return confirm('Are you sure you want to add?')" >Add</button></a></td>
