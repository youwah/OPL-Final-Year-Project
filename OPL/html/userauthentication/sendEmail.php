...
require '/home/crimsonw/public_html/s272043/OPL/html/userauthentication/PHPMailer/Exception.php';
require '/home/crimsonw/public_html/s272043/OPL/html/userauthentication/PHPMailer/PHPMailer.php';
require '/home/crimsonw/public_html/s272043/OPL/html/userauthentication/PHPMailer/SMTP.php';
...
$emailReset = "SELECT * FROM tbl_272043_student WHERE email='".strtolower($email)."'";
$result = $conn->query($emailReset);

if($result->num_rows>0){
    $sqlupdate= "UPDATE tbl_272043_student SET password = '$password' WHERE email='".strtolower($email)."'";
...
function sendEmail($email,$pass){
    ...
    $mail->SMTPAuth= true; 
    $mail->Username= 'noreply@crimsonwebs.com'; 
    $mail->Password= 'xS)1DEbCZCwO';
    $mail->SMTPSecure= 'none';         
    $mail->Port= 25;
    
    $mail->setFrom("noreply@crimsonwebs.com","OPL");
    ...
    Thank You.<br><br>Sincerely,<br>Customer Service<br>OPL.<br><br>
