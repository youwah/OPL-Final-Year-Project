...
<p class="mb-100 mt-10"><br>
    ...
    <p align=center>
		...
		<div style="height:-10px; width:100px; background-color:white; margin-left:auto;margin-right:auto; position:relative">
		  ...
		  <h3 style="text-align:center;" class="display-4">Role:Lecturer</h3>
		  
		  	</div>
<div class="flex-parent jc-center">
  <button type="submit" onclick="document.location='viewstudentlog.php'" class="green margin-right">View Logbook</button>
  <button type="submit" onclick="document.location='lecprofile.php'" class="magenta">My Profile</button>
</div>
		<?php
	        }}?>
