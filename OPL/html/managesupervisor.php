...
<script src="https://kit.fontawesome.com/56e1a6fc52.js" crossorigin="anonymous"></script>
	...
	<title>Supervisor Name List</title>
...
<h2 style="text-align:center; font-size: 50px; margin-top: 0.15em; margin-bottom: -1em;">Supervisor Name List</h2>
...
<div class="select" >
    <?php
        ...
        $status =$_POST['status'];
         ...
         $sqlloaduser = "SELECT * FROM tbl_272043_supervisor ";
...
<div class="container2">
	...
	<table id="example"  style="width:100%">
	   ...
	   <tr>
                ...
                <td><a href="viewintern.php?email=<?php echo $row["email"]; ?>&namesup=<?php echo $row["lname"] ?>"><button type="button" >View</button></a></td>
                <td><a href="addintern.php?email=<?php echo $row["email"]; ?>&supname=<?php echo $row["lname"] ?>"><button type="button" >Add</button></a></td>
