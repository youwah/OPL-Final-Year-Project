...
<div>
<h2 style="text-align:center; font-size: 50px; margin-top: 0.15em; margin-bottom: -1em;"><?php echo $_GET["studentname"]; ?>'s Check in List</h2>
</div><br><br><br>
<div class="select" >
    <?php
        session_start();
        ...
        $month =$_POST['month'];
         ...
         $sqlloaduser = "SELECT * FROM tbl_272043_location WHERE email ='$studentemail'";
         
     if(isset($_POST['sortyear'])){

            $sqlloaduser = "SELECT * FROM tbl_272043_location WHERE month ='$month' AND email ='$studentemail'";
        }
...
/*	    session_start();
	   ...
	   <tr>
                ...
                <td><a href="showlocation.php?studentemail=<?php echo $row["email"]; ?>&studentname=<?php echo $_GET["studentname"]; ?>&latitude=<?php echo $row["latitude"] ?>&longitude=<?php echo $row["longitude"]; ?>"><button type="button" >Check</button></a></td>
