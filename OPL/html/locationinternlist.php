...
<div class="container2">
	...
	<table id="example"  style="width:100%">
	   ...
	   <tr>
                ...
                <td><a href="internporfileloc.php?studentemail=<?php echo $row["semail"]; ?>"><?php echo $row["semail"] ?></a></td>
                <td><?php echo $row["name"] ?></td>
                <td><?php echo $row["ic_number"] ?></td>
                <td><a href="checklocation.php?studentemail=<?php echo $row["semail"]; ?>&studentname=<?php echo $row["name"]; ?>"><button type="button" >View</button></a></td>
