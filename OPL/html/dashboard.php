            ...
            if (isset($_SESSION["email"])){
             $sqlloaduser = "SELECT * FROM tbl_272043_student WHERE email = '$email' AND password = '$password' ";
                ...
                <?php
                        ...
                        ?>
                        <img style= "height: 30px;width: 30px; border-radius:50%;position:absolute;right:20%;top:13%" src="../images/user.png" alt="profileimg">
                    <?php
                    }
...
<p class="mb-100 mt-10"><br>
    ...
    <h3 style="text-align:center;" class="display-4">Role:Student</h3>
		   <p align=center> 
		</div>
  ...
  <div class="column" >
     ...
     <button type="submit" class="btn" onclick="document.location='actionReport.php'"><b>View Logbook</b></button>
  </div>  
  
  
  <div class="column">
      <button type="submit" class="btn2" onclick="document.location='action.php'"><b>Add Today Log</b></button>
  </div>  
  
  <div class="column" >
      <button type="submit" class="btn3" onclick="document.location='addlocation.php'"><b>Check In Locaion</b></button>
  </div>  
